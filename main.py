...
async def generate_signal_card_image(signal: Signal) -> str:
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .card {{ width: 700px; background: rgba(5, 5, 10, 0.55); border: 2px solid rgba(0, 255, 136, 0.7); border-radius: 40px; padding: 60px; color: #ffffff; box-shadow: 0 10px 60px rgba(0,0,0,0.95); display: flex; flex-direction: column; justify-content: center; }}
