...
async def generate_signal_card_image(signal: Signal) -> str:
    ...
    <head><style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .live-badge {{ background: rgba(212, 163, 115, 0.8); padding: 10px 20px; border-radius: 20px; color: black; font-weight: bold; font-size: 14px; }}
        ...
        .stat-label {{ font-size: 16px; color: rgba(255, 255, 255, 0.5); margin-bottom: 15px; font-weight: 500; }}
